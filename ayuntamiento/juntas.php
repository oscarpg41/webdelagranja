...
<div id="titulo1">:: ACTAS DE JUNTA DE GOBIERNO LOCAL<img src="images/spacer.gif" width="2" border="0"></a> </div><div id="texto_main_normal">
...
<?php 
     ...
     $query = "select tipo, fecha, titulo, enlace from ayuntamiento where tipo=2";  
	...
	print ("Error al recuperar los enlaces");
       ...
       }else echo '<TR><TD colspan=2 align="center" height="40px"><B>No hay Actas de Juntas de Gobierno dadas de alta. <br> Busca en la web del Ayuntamiento: <a href="http://www.lagranja-valsain.com/normativa.asp" class="link2">http://www.lagranja-valsain.com/normativa.asp</a></B></TD></TR>';
     }   
?>
</table>  
