<html>
<head>
<title>Situacion | La Granja | San Ildefonso | Valsain | Palacio Real | Jardines y Fuentes | Sierra de Guadarrama |Segovia Sur </title>
...
<DIV id="titulo1">:: D&oacute;nde Estamos</DIV>

<TABLE border="0" width="98%">
<TR>
  <TD align="center" width="180" class="puntos"><IMG src="images/conocer/europa.gif" width ="171"></TD>
  <TD align="left" class="puntos"><IMG src="images/conocer/espana.gif" width ="171"></TD>
 </TR>   
 <TR>
  <TD align="center" class="puntos"><IMG src="images/conocer/cyl.gif" width ="171"></TD>
  <TD align="left" valign="top" class="puntos">	
    <P align="justify" class="text">
    La Granja se encuentra situada al sur de la provincia de Segovia, en las inmediaciones de la Sierra 
    de Guadarrama. <br>
    A los pies del Peñalara, el pico más alto de la Sierra de Guadarrama. <br><br>
    
    Nos encontramos a 11 km de Segovia la capital de la provincia y a unos 80 Km de Madrid, capital de España. <br><br>
    Se tarda más o menos una hora en recorrer el trayecto Madrid-La Granja. <br><br>
    
    <b>Coordenadas GPS: 40.900802, -4.005327</b>
    </P>    
  </TD>
 </TR>   
</TABLE>
